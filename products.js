const products = [
    ...
    },
    {
        ...
        colors: [
            {
                name: "Grey",
                mainImage: "images/ATR-JSY-FBL-CDR-001.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
    },
    {
        ...
        colors: [
            {
                name: "Green",
                mainImage: "images/ATR-JSY-FBL-CDR-006.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
    },
    {
        ...
        colors: [
            {
                name: "Black",
                mainImage: "images/ATR-JSY-FBL-CDR-005.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
    },
    {
        ...
        colors: [
            {
                name: "Brown",
                mainImage: "images/ATR-JSY-FBL-CDR-004.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
    },
    {
        ...
        colors: [
            {
                name: "Blue",
                mainImage: "images/ATR-JSY-FBL-CDR-003.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
    },
    {
        ...
        colors: [
            {
                name: "Green",
                mainImage: "images/ATR-JSY-FBL-PSD-002.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ],
        whatsapp: "halo Admin, saya ingin jersey dengan desain ini apakah bisa?"
    }
];
